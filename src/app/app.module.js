...
var AppModule = (function () {
    ...
    AppModule = __decorate([
        core_1.NgModule({
            imports: [platform_browser_1.BrowserModule, http_1.HttpModule, forms_1.FormsModule, router_1.RouterModule, multiselect_dropdown_1.MultiselectDropdownModule],
            ...
            providers: [regions_service_1.RegionService, citations_service_1.CitationService, eventSharing_service_1.SharedService]
        })
    ], AppModule);
    return AppModule;
}());
