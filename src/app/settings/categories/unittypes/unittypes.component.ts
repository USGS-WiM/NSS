...
export class UnitTypesComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        ...
        this._settingsservice.getEntities(this.configSettings.unitsURL).subscribe(units => {
    ...
    public saveUnit(c: Unittype, i: number) {
    ...
    public deleteUnit(catID: number) {
    ...
    private getUnitIndex(cID: number): number {
        return 0;
        /*let ind: number = -1
