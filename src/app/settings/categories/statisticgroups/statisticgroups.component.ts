...
export class StatisticGroupsComponent implements OnInit, OnDestroy {
    ...
    public onRegSelect(r: Region) {
        ...
        this._settingsservice.getEntities(this.configSettings.regionURL + r.id + '/' + this.configSettings.statisticGrpURL).subscribe(sg => {
    ...
    public saveStatGroup(c: Statisticgroup, i: number) {
    ...
    public deleteStatGroup(catID: number) {
    ...
    private getStatGroupIndex(cID: number): number {
        return 0;
        /*let ind: number = -1
