...
@NgModule({
  declarations: [
    ...
    ProfileComponent, ErrorsComponent, RegionsComponent, AddScenarioModal, ManageCitationsModal, CitationFilterPipe, MapComponent
  ],
  imports: [
    ...
    RouterModule.forRoot(appRoutes, {onSameUrlNavigation: 'reload'}), HttpClientModule
  ],
  providers: [
    ...
    LoginService, AuthService, SettingsService, AuthGuard, AdminGuard, ShapeService
  ],
